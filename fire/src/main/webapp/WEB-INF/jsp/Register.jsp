...
<html xmlns="http://www.w3.org/1999/xhtml"
	xmlns:th="http://www.thymeleaf.org" th:include="Template :: page">
	...
	<div th:fragment="content">
		...
		<div class="panel panel-default">
			...
			<div class="jumbotron">
				...
				<h4>Existing customers log in. New customers please register
					your details</h4>
		...
		<div class="col-md-6">
			<form th:action="@{postLogin}" method="post">
				<div id="centre">
					...
					<p>
						<strong>Username :</strong><br /> <input type="text"
							name="username" />
					</p>
					<p>
			...
			<div class="col-md-6">
				<div class="panel-body">
					<div id="centre">
						...
						<p>
							<label for="firstnamesignup" class="fname" data-icon="u">First
								Name:</label> <input id="firstnamesignup" name="firstnamesignup"
								required="required" type="text" placeholder="First" />
						</p>
						<p>
							<label for="lastnamesignup" class="lname" data-icon="u">Last
								Name:</label> <input id="lastnamesignup" name="lastnamesignup"
								required="required" type="text" placeholder="Last" />
						</p>


						<p>
							<label for="addresssignup" class="uname" data-icon="u">Address:</label>
							<input id="addresssignup" name="addresssignup"
								required="required" type="text" placeholder="Address" />
						</p>
						...
						<p>
							<label for="passwordsignup_confirm" class="password"
