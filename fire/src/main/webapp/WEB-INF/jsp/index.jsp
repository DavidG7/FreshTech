...
<!--------------------------------------------->
<!------THIS FORM SUMBITS DATA TO JSP FORM
THEN FROM JSP FORM IT ADDES DATA TO DUMMYDATA AND PRINTS IT
<!--------------------------------------------->
    ...
    <input  type="image"  alt="Register"  src="ImageFolder/Register.png">
	   </div>
</form>
</div>
...
<!----------------------------->
		...
		<div id = "footer" class = "panel-footer">
			...
			<p>
				 This page was used to test a way to add data into our DummyData class 
			</p>
